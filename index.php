...
<header id="stickyHeader">
    <div class="container">
      <div class="top-bar">
        <div class="logo">
          <a href="#">
            <img alt="logo" src="assets/img/logo.png" width="250px" style="    background: white;
    padding: 12px;
    box-shadow: 0 0 10px white;border-radius:10px">
          </a>
        </div>
        <!-- <nav>
          <ul>
...
<section class="hero-section" style="
    background-image: linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.9)), 
                      url('https://apacnewsnetwork.com/wp-content/uploads/2022/12/Indian-Students-Flying-Abroad-For-Education-Jumps-To-5-Year-High-in-2022-600x375.png');
      ...
      <div class="col-lg-7">
        <div class="hero-text">
          ...
          <div class="video">
            ...
            <!-- <img src="assets/img/girl.webp" alt="girl" class="heroimg"> -->
        </div>
            ...
            <div>
                ...
                <div class="d-flex align-items-center">
                    <div class="radio-button">
                        ...
                        <label for="Virtual">VirtualIn-Office</label>
                    </div>
                    <div class="radio-button">
                       <input type="radio" id="css" name="fav_language" value="In-Office">
                        <label for="css">VirtualIn-Office</label><br>
                    </div>
                </div> -->
                <button type="submit" class="btn batton"> Start Free Trial </button>
        </form> 
      </div>
    </div>
  </div>
...
<section id="about" class="gap">
  <div class="container">
    <div class="heading">
      ...
      <h2>Build and Customize Your <br>Perfect Landing Page</h2>
    </div>
    <div class="row align-items-center">
      <div class="col-lg-7">
        <div class="customize-img">
          <img alt="customize" src="assets/img/customize.png">
        </div>
      </div>
      <div class="col-lg-5">
...
">
    ...
    padding: 0;
    margin: 0;
    width: 100% !important;!im;!imo;!imor;!imo;!i;!;
">About TS Mishra Sir </h2>
    </div><p>Enim ad minim veniam, quis nostrud exercitat ullrem ipsum dolor sit amet, consece adipising elit, o eiusmod tempor incididunt ut labore bit of how ther chancer flat bogeo viele marioa.</p>
          <ul>
              <li><img alt="check" src="assets/img/check-b.png">Get high conversion rates</li>
              <li><img alt="check" src="assets/img/check-b.png"> Engage more users</li>
              <li><img alt="check" src="assets/img/check-b.png">Bring it to life again with us</li>
      ...
      <a class="btn" href="mailto:username@domain.com">Enroll Now</a>
    </div>
    </div>
...
<div class="row">
  ...
  <div class="col-md-5">
  <div class="customize-img">
          <img alt="customize" src="assets/img/customize-2.png">
        </div>
  </div>
 </div>
...
<section id="services" class="gap">
  <div class="container">
    <div class="heading ">
      ...
      <h2>Create a Landing Page In a <br>Minute Not Weeks</h2>
    </div>
    <div class="row">
  ...
  <div class="container">
    ...
    <div class="logodata owl-carousel owl-theme">
          <div class="partner item">
            <img alt="sponsor-img" src="assets/img/sponsor-1.png">
          </div>
          <div class="partner item">
            <img alt="sponsor-img" src="assets/img/sponsor-2.png">
          </div>
          <div class="partner item">
            <img alt="sponsor-img" src="assets/img/sponsor-3.png">
          </div>
          <div class="partner item">
            <img alt="sponsor-img" src="assets/img/sponsor-4.png">
          </div>
          <div class="partner item">
            <img alt="sponsor-img" src="assets/img/sponsor-5.png">
          </div>
    </div>
  </div>
</section> 
        ...
        <div class="row">
          ...
          <div class="col-md-9">
            <div class="newsletter-text">
              ...
              <a href="#" class="btn">subscribe Email</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="accordion">
                <div class="accordion-item">
                    <a href="#" class="heading">
                        <div class="icon"></div>
                        <div class="title">What is a business consultant?</div>
                    </a>

                    <div class="content">
                        <p>Enim ad minim veniam, quis nostrud exercitat ullrem ipsum dolor sit amet, consece adipising elit, o eiusmod tempor incididunt ut labore bit of how ther chancer flat bogeo viele marioa.
                        </p>
                    </div>
                </div>
                ...
                <div class="accordion-item active">
                    <a href="#" class="heading" >
                        <div class="icon"></div>
                        <div class="title">I need a business consulting service? </div>
                    </a>
                ...
                <div class="accordion-item">
                    <a href="#" class="heading">
                        <div class="icon"></div>
                        <div class="title">Donate or fundraise</div>
                    </a>
                ...
                <div class="accordion-item">
                    <a href="#" class="heading">
                        <div class="icon"></div>
                        <div class="title">How do you price your services?</div>
                    </a>
